...
const Ex12 = () => {
    ...
    // 3. componentDidMount 시점(useEffect 훅 사용)에서 API Call
    useEffect(() => {
        /* 
            ...
            2. axios 라이브러리
             - 장점 : 기능이 매우 다양, 기본적으로 제공하는 편의 기능이 풍부하다.
        ...
        */
        ...
        const key = "55da34d8d6a3610cad13cfb55516d15a";
        ...
        /* 
            Case2. axios
            2-1. npm i axios
                : axios는 라이브러리이기 때문에 반드시 설치 해야한다
            2-2. import axios from 'axois'
                : axios 라이브러리를 사용하기 위해 import로 불러오기
        */
       axios.get(url, {
        params : {
            key,
